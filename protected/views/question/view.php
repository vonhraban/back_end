...
$this->menu=array(
	...
	array('label'=>Yii::t('app', 'Update') . ' ' . $model->label(), 'url'=>array('update', 'id' => $model->question_id)),
	array('label'=>Yii::t('app', 'Delete') . ' ' . $model->label(), 'url'=>'#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->question_id), 'confirm'=>'Are you sure you want to delete this item?')),
...
<?php
	...
	foreach($model->options as $relatedModel) {
		...
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('option/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
